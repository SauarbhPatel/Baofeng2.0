...
const PaymentMethod = ({ paymentMethods = [], selectedPayment, onSelect }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            {paymentMethods.map((method) => {
                const isActive = selectedPayment?._id === method._id;
                return (
                    <TouchableOpacity
                        key={method._id}
                        style={[
                    ...
                    >
                        <View style={styles.cardHeader}>
                            ...
                            {method.methodFavIcon ? (
                                <Image
                                    source={{ uri: method.methodFavIcon }}
                                    style={styles.logo}
                                    resizeMode="contain"
                                />
                            ) : (
...
const styles = StyleSheet.create({
    ...
    methodTitle: { fontSize: 16, fontWeight: "700", color: "#000", flex: 1 },
    logo: { width: 40, height: 40, marginLeft: "auto" },
    codBadge: {
        borderWidth: 1,
        borderColor: "#000",
        borderRadius: 4,
    ...
    codText: { fontSize: 12, fontWeight: "900" },
    ...
    secureText: { flex: 1, fontSize: 13, color: "#64748b", lineHeight: 18 },
});
