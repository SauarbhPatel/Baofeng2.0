...
const OrderDashboard = ({ activeTab, setActiveTab, counts = {} }) => {
    const tabs = [
        "All Orders",
        "Processing",
        "Shipped",
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Statistics Grid — dynamic from API counts */}
            <View style={styles.statsGrid}>
                <View style={styles.statsRow}>
                    <StatCard
                        icon="package-variant"
...
const styles = StyleSheet.create({
    ...
    statsGrid: { gap: 8, marginBottom: 15 },
    ...
    statContent: {},
    statCount: { fontSize: 16, fontWeight: "800", color: "#0f172a" },
    statLabel: { fontSize: 11, color: "#8A7E72" },
    searchContainer: {
        flexDirection: "row",
        alignItems: "center",
        backgroundColor: "#fff",
    ...
    tabText: { fontSize: 12, fontWeight: "600", color: "#8A7E72" },
