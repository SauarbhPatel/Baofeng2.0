...
//                         style={[
//                             styles.radioCircle,
//                             isDefault && styles.radioCircleSelected,
//                         ]}
//                     >
...
//                 </View>
//                 <TouchableOpacity onPress={onEdit} style={{ marginEnd: 8 }}>
...
const AddressScreen = ({ navigation }) => {
    ...
    // ── Edit address — navigate to dedicated screen ───────────
        ...
        <View style={[styles.addressCard, isSelected && styles.selectedBorder]}>
            ...
            <View style={styles.addressHeader}>
                ...
                <TouchableOpacity style={styles.actionIconBtn} onPress={onEdit}>
                    <Feather name="edit-3" size={15} color="#0064a3" />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                    style={[
                        ...
                        { marginLeft: 6, borderColor: "#fecaca" },
                    ]}
                    onPress={onDelete}
                >
